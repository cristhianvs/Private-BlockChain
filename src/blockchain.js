...
class Blockchain {
    ...
    requestMessageOwnershipVerification(address) {
        return new Promise((resolve) => {
            const messageOwnershipVerification = `${address}:${new Date().getTime().toString().slice(0,-3)}:starRegistry`;
            resolve(messageOwnershipVerification);
        });
    }
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (elapsedTime < 300){
                ...
                reject(Error('Time elapsed more than 5 minutes'));
            }
        });
    }
